...
CREATE OR REPLACE FUNCTION proc.update_group(
...
BEGIN
    ...
    v_hidden := p_params->>'hidden';
    v_notesid := p_params->>'notesid';
    ...
    IF v_rows_updated < 1 THEN
        RAISE EXCEPTION 'No records updated. group ID % not found', v_id ;
    END IF;
